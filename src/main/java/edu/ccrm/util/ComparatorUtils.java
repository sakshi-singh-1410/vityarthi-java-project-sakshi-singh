...
public final class ComparatorUtils {
    ...
    public static final Comparator<Student> BY_DEPARTMENT = (s1, s2) -> s1.getDepartment().compareTo(s2.getDepartment());
    ...
    public static final Comparator<Course> BY_DEPARTMENT = Comparator.comparing(Course::getDepartment);
    ...
    public static final Comparator<Student> BY_DEPARTMENT_THEN_YEAR = 
        BY_DEPARTMENT.thenComparing(BY_YEAR);
    ...
    public static Comparator<Student> byYearAndDepartment(boolean yearAscending, boolean deptAscending) {
        ...
        Comparator<Student> deptComp = deptAscending ? BY_DEPARTMENT : BY_DEPARTMENT.reversed();
